...
import {
  ...
  require_shams,
  require_src
} from "./chunk-346RERA5.js";
import "./chunk-BK5SWADC.js";
import {
  esm_default
} from "./chunk-J6CEENEN.js";
import "./chunk-XOWOABI5.js";
import "./chunk-U5IBFF6O.js";
import {
  require_client_logger
} from "./chunk-LAO35BDL.js";
import {
  __commonJS,
  __esm,
  __export,
...
var require_ansi_styles = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/node_modules/ansi-styles/index.js"(exports, module2) {
    "use strict";
...
var require_collections = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/collections.js"(exports) {
    "use strict";
...
var require_AsymmetricMatcher = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/plugins/AsymmetricMatcher.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_ConvertAnsi = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/plugins/ConvertAnsi.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_DOMCollection = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/plugins/DOMCollection.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_escapeHTML = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/plugins/lib/escapeHTML.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_markup = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/plugins/lib/markup.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var printElement3 = (type, printedProps, printedChildren, config3, indentation) => {
      const tagColor = config3.colors.tag;
      return tagColor.open + "<" + type + (printedProps && tagColor.close + printedProps + config3.spacingOuter + indentation + tagColor.open) + (printedChildren ? ">" + tagColor.close + printedChildren + config3.spacingOuter + indentation + tagColor.open + "</" + type : (printedProps && !config3.min ? "" : " ") + "/") + ">" + tagColor.close;
    };
    exports.printElement = printElement3;
    var printElementAsLeaf3 = (type, config3) => {
      const tagColor = config3.colors.tag;
...
var require_DOMElement = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/plugins/DOMElement.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var serialize = (node, config3, indentation, depth, refs, printer) => {
      ...
      const type = nodeIsFragment3(node) ? "DocumentFragment" : node.tagName.toLowerCase();
      if (++depth > config3.maxDepth) {
        return (0, _markup.printElementAsLeaf)(type, config3);
      }
...
var require_Immutable = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/plugins/Immutable.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var SPACE = " ";
    var LAZY = "…";
    var printImmutableEntries = (val, config3, indentation, depth, refs, printer, type) => ++depth > config3.maxDepth ? printAsLeaf(getImmutableName(type)) : getImmutableName(type) + SPACE + "{" + (0, _collections.printIteratorEntries)(
      val.entries(),
      config3,
      indentation,
      depth,
    ...
    var printImmutableValues = (val, config3, indentation, depth, refs, printer, type) => ++depth > config3.maxDepth ? printAsLeaf(getImmutableName(type)) : getImmutableName(type) + SPACE + "[" + (0, _collections.printIteratorValues)(
      val.values(),
      config3,
      indentation,
      depth,
...
var require_react_is_development = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/react-is/cjs/react-is.development.js"(exports) {
    "use strict";
    if (true) {
      (function() {
        "use strict";
...
var require_react_is = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/react-is/index.js"(exports, module2) {
    "use strict";
    if (false) {
...
var require_ReactElement = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/plugins/ReactElement.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_ReactTestComponent = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/plugins/ReactTestComponent.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_build = __commonJS({
  "node_modules/@storybook/testing-library/node_modules/pretty-format/build/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var dom_esm_exports2 = {};
__export(dom_esm_exports2, {
...
function createDOMElementFilter2(filterNode) {
  return {
    test: (val) => {
      ...
      return (val == null ? void 0 : (_val$constructor2 = val.constructor) == null ? void 0 : _val$constructor2.name) && testNode2(val);
    },
    serialize: (node, config3, indentation, depth, refs, printer) => {
      ...
      if (++depth > config3.maxDepth) {
        return printElementAsLeaf2(type, config3);
      }
      return printElement2(type, printProps2(nodeIsFragment2(node) ? [] : Array.from(node.attributes).map((attr) => attr.name).sort(), nodeIsFragment2(node) ? {} : Array.from(node.attributes).reduce((props, attribute) => {
        props[attribute.name] = attribute.value;
        return props;
...
function waitFor2(callback, _ref) {
  let {
    ...
    interval = 50,
    onTimeout = (error) => {
      error.message = getConfig2().getElementError(error.message, container).message;
      return error;
    },
...
function initialCheck2(elements) {
  if (isRemoved2(elements)) {
...
var prettyFormat2, import_aria_query2, import_lz_string2, printProps2, NodeTypeTextNode2, printChildren2, printText2, printComment2, printElement2, printElementAsLeaf2, ELEMENT_NODE$12, TEXT_NODE$12, COMMENT_NODE$12, FRAGMENT_NODE2, ELEMENT_REGEXP2, testNode2, chalk2, readFileSync2, codeFrameColumns2, TEXT_NODE2, shouldHighlight2, DOMCollection2, ELEMENT_NODE2, COMMENT_NODE2, logDOM2, config2, labelledNodeNames2, elementRoleList2, logRoles2, normalize2, wrapSingleQueryWithSuggestion2, wrapAllByQueryWithSuggestion2, queryHelpers2, queryAllLabelsByText2, queryAllByLabelText2, getAllByLabelText2, getMultipleError$72, queryByLabelText2, getByLabelText2, findAllByLabelText2, findByLabelText2, getAllByLabelTextWithSuggestions2, getByLabelTextWithSuggestions2, queryAllByLabelTextWithSuggestions2, queryAllByPlaceholderText2, getMultipleError$62, getMissingError$62, queryAllByPlaceholderTextWithSuggestions2, queryByPlaceholderText2, getAllByPlaceholderText2, getByPlaceholderText2, findAllByPlaceholderText2, findByPlaceholderText2, queryAllByText2, getMultipleError$52, getMissingError$52, queryAllByTextWithSuggestions2, queryByText2, getAllByText2, getByText2, findAllByText2, findByText2, queryAllByDisplayValue2, getMultipleError$42, getMissingError$42, queryAllByDisplayValueWithSuggestions2, queryByDisplayValue2, getAllByDisplayValue2, getByDisplayValue2, findAllByDisplayValue2, findByDisplayValue2, VALID_TAG_REGEXP2, queryAllByAltText2, getMultipleError$32, getMissingError$32, queryAllByAltTextWithSuggestions2, queryByAltText2, getAllByAltText2, getByAltText2, findAllByAltText2, findByAltText2, isSvgTitle2, queryAllByTitle2, getMultipleError$22, getMissingError$22, queryAllByTitleWithSuggestions2, queryByTitle2, getAllByTitle2, getByTitle2, findAllByTitle2, findByTitle2, queryAllByRole2, getNameHint2, getMultipleError$12, getMissingError$12, queryAllByRoleWithSuggestions2, queryByRole2, getAllByRole2, getByRole2, findAllByRole2, findByRole2, getTestIdAttribute2, queryAllByTestId2, getMultipleError2, getMissingError2, queryAllByTestIdWithSuggestions2, queryByTestId2, getAllByTestId2, getByTestId2, findAllByTestId2, findByTestId2, queries2, isRemoved2, eventMap2, eventAliasMap2, debug2, logTestingPlaygroundURL2, initialValue2, screen2;
var init_dom_esm = __esm({
  "node_modules/@testing-library/dom/dist/@testing-library/dom.esm.js"() {
    prettyFormat2 = __toESM(require_build2());
    init_dist();
    import_aria_query2 = __toESM(require_lib());
    import_lz_string2 = __toESM(require_lz_string());
    printProps2 = (keys, props, config3, indentation, depth, refs, printer) => {
      const indentationNext = indentation + config3.indent;
      const colors = config3.colors;
      return keys.map((key) => {
        const value = props[key];
    ...
    NodeTypeTextNode2 = 3;
    printChildren2 = (children, config3, indentation, depth, refs, printer) => children.map((child) => {
    ...
    printElement2 = (type, printedProps, printedChildren, config3, indentation) => {
      const tagColor = config3.colors.tag;
      return tagColor.open + "<" + type + (printedProps && tagColor.close + printedProps + config3.spacingOuter + indentation + tagColor.open) + (printedChildren ? ">" + tagColor.close + printedChildren + config3.spacingOuter + indentation + tagColor.open + "</" + type : (printedProps && !config3.min ? "" : " ") + "/") + ">" + tagColor.close;
    };
    printElementAsLeaf2 = (type, config3) => {
      const tagColor = config3.colors.tag;
      return tagColor.open + "<" + type + tagColor.close + " …" + tagColor.open + " />" + tagColor.close;
    };
    ELEMENT_NODE$12 = 1;
    ...
    COMMENT_NODE$12 = 8;
    FRAGMENT_NODE2 = 11;
    ELEMENT_REGEXP2 = /^((HTML|SVG)\w*)?Element$/;
    testNode2 = (val) => {
      const constructorName = val.constructor.name;
      const {
        nodeType,
      ...
      return nodeType === ELEMENT_NODE$12 && (ELEMENT_REGEXP2.test(constructorName) || isCustomElement) || nodeType === TEXT_NODE$12 && constructorName === "Text" || nodeType === COMMENT_NODE$12 && constructorName === "Comment" || nodeType === FRAGMENT_NODE2 && constructorName === "DocumentFragment";
    };
    chalk2 = null;
    readFileSync2 = null;
    codeFrameColumns2 = null;
    try {
    ...
    labelledNodeNames2 = ["button", "meter", "output", "progress", "select", "textarea", "input"];
    elementRoleList2 = buildElementRoleList2(import_aria_query2.elementRoles);
    logRoles2 = function(dom, _temp2) {
      let {
        hidden = false
      } = _temp2 === void 0 ? {} : _temp2;
      return console.log(prettyRoles2(dom, {
        hidden
      }));
    };
    normalize2 = getDefaultNormalizer2();
    wrapSingleQueryWithSuggestion2 = (query, queryAllByName, variant) => function(container) {
    ...
    wrapAllByQueryWithSuggestion2 = (query, queryAllByName, variant) => function(container) {
    ...
    queryAllLabelsByText2 = function(container, text, _temp) {
      let {
        exact = true,
        trim,
        collapseWhitespace,
    ...
    queryAllByLabelText2 = function(container, text, _temp2) {
      let {
        selector = "*",
        exact = true,
        collapseWhitespace,
    ...
    getAllByLabelText2 = function(container, text) {
    ...
    getMultipleError$72 = (c, text) => "Found multiple elements with the text of: " + text;
    queryByLabelText2 = wrapSingleQueryWithSuggestion2(makeSingleQuery2(queryAllByLabelText2, getMultipleError$72), queryAllByLabelText2.name, "query");
    getByLabelText2 = makeSingleQuery2(getAllByLabelText2, getMultipleError$72);
    findAllByLabelText2 = makeFindQuery2(wrapAllByQueryWithSuggestion2(getAllByLabelText2, getAllByLabelText2.name, "findAll"));
    findByLabelText2 = makeFindQuery2(wrapSingleQueryWithSuggestion2(getByLabelText2, getAllByLabelText2.name, "find"));
    getAllByLabelTextWithSuggestions2 = wrapAllByQueryWithSuggestion2(getAllByLabelText2, getAllByLabelText2.name, "getAll");
    getByLabelTextWithSuggestions2 = wrapSingleQueryWithSuggestion2(getByLabelText2, getAllByLabelText2.name, "get");
    queryAllByLabelTextWithSuggestions2 = wrapAllByQueryWithSuggestion2(queryAllByLabelText2, queryAllByLabelText2.name, "queryAll");
    queryAllByPlaceholderText2 = function() {
    ...
    getMultipleError$62 = (c, text) => "Found multiple elements with the placeholder text of: " + text;
    getMissingError$62 = (c, text) => "Unable to find an element with the placeholder text of: " + text;
    queryAllByPlaceholderTextWithSuggestions2 = wrapAllByQueryWithSuggestion2(queryAllByPlaceholderText2, queryAllByPlaceholderText2.name, "queryAll");
    [queryByPlaceholderText2, getAllByPlaceholderText2, getByPlaceholderText2, findAllByPlaceholderText2, findByPlaceholderText2] = buildQueries2(queryAllByPlaceholderText2, getMultipleError$62, getMissingError$62);
    queryAllByText2 = function(container, text, _temp) {
      let {
        selector = "*",
        exact = true,
        collapseWhitespace,
    ...
    getMultipleError$52 = (c, text) => "Found multiple elements with the text: " + text;
    getMissingError$52 = function(c, text, options) {
      if (options === void 0) {
        options = {};
      }
      const {
    ...
    queryAllByTextWithSuggestions2 = wrapAllByQueryWithSuggestion2(queryAllByText2, queryAllByText2.name, "queryAll");
    [queryByText2, getAllByText2, getByText2, findAllByText2, findByText2] = buildQueries2(queryAllByText2, getMultipleError$52, getMissingError$52);
    queryAllByDisplayValue2 = function(container, value, _temp) {
      let {
        exact = true,
        collapseWhitespace,
        trim,
    ...
    getMultipleError$42 = (c, value) => "Found multiple elements with the display value: " + value + ".";
    getMissingError$42 = (c, value) => "Unable to find an element with the display value: " + value + ".";
    queryAllByDisplayValueWithSuggestions2 = wrapAllByQueryWithSuggestion2(queryAllByDisplayValue2, queryAllByDisplayValue2.name, "queryAll");
    [queryByDisplayValue2, getAllByDisplayValue2, getByDisplayValue2, findAllByDisplayValue2, findByDisplayValue2] = buildQueries2(queryAllByDisplayValue2, getMultipleError$42, getMissingError$42);
    VALID_TAG_REGEXP2 = /^(img|input|area|.+-.+)$/i;
    queryAllByAltText2 = function(container, alt, options) {
      if (options === void 0) {
        options = {};
      }
      checkContainerType2(container);
    ...
    getMultipleError$32 = (c, alt) => "Found multiple elements with the alt text: " + alt;
    getMissingError$32 = (c, alt) => "Unable to find an element with the alt text: " + alt;
    queryAllByAltTextWithSuggestions2 = wrapAllByQueryWithSuggestion2(queryAllByAltText2, queryAllByAltText2.name, "queryAll");
    [queryByAltText2, getAllByAltText2, getByAltText2, findAllByAltText2, findByAltText2] = buildQueries2(queryAllByAltText2, getMultipleError$32, getMissingError$32);
    isSvgTitle2 = (node) => {
      var _node$parentElement;
      return node.tagName.toLowerCase() === "title" && ((_node$parentElement = node.parentElement) == null ? void 0 : _node$parentElement.tagName.toLowerCase()) === "svg";
    };
    queryAllByTitle2 = function(container, text, _temp) {
      let {
        exact = true,
        collapseWhitespace,
        trim,
    ...
    getMultipleError$22 = (c, title) => "Found multiple elements with the title: " + title + ".";
    getMissingError$22 = (c, title) => "Unable to find an element with the title: " + title + ".";
    queryAllByTitleWithSuggestions2 = wrapAllByQueryWithSuggestion2(queryAllByTitle2, queryAllByTitle2.name, "queryAll");
    [queryByTitle2, getAllByTitle2, getByTitle2, findAllByTitle2, findByTitle2] = buildQueries2(queryAllByTitle2, getMultipleError$22, getMissingError$22);
    queryAllByRole2 = function(container, role, _temp) {
      let {
    ...
    getMultipleError$12 = function(c, role, _temp2) {
      let {
        name
      } = _temp2 === void 0 ? {} : _temp2;
      return 'Found multiple elements with the role "' + role + '"' + getNameHint2(name);
    };
    getMissingError$12 = function(container, role, _temp3) {
      let {
        hidden = getConfig2().defaultHidden,
        name,
        description
    ...
    queryAllByRoleWithSuggestions2 = wrapAllByQueryWithSuggestion2(queryAllByRole2, queryAllByRole2.name, "queryAll");
    [queryByRole2, getAllByRole2, getByRole2, findAllByRole2, findByRole2] = buildQueries2(queryAllByRole2, getMultipleError$12, getMissingError$12);
    getTestIdAttribute2 = () => getConfig2().testIdAttribute;
    queryAllByTestId2 = function() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      checkContainerType2(args[0]);
    ...
    getMultipleError2 = (c, id) => "Found multiple elements by: [" + getTestIdAttribute2() + '="' + id + '"]';
    getMissingError2 = (c, id) => "Unable to find an element by: [" + getTestIdAttribute2() + '="' + id + '"]';
    queryAllByTestIdWithSuggestions2 = wrapAllByQueryWithSuggestion2(queryAllByTestId2, queryAllByTestId2.name, "queryAll");
    [queryByTestId2, getAllByTestId2, getByTestId2, findAllByTestId2, findByTestId2] = buildQueries2(queryAllByTestId2, getMultipleError2, getMissingError2);
    queries2 = Object.freeze({
      __proto__: null,
      queryAllByLabelText: queryAllByLabelTextWithSuggestions2,
      queryByLabelText: queryByLabelText2,
      getAllByLabelText: getAllByLabelTextWithSuggestions2,
    ...
    isRemoved2 = (result) => !result || Array.isArray(result) && !result.length;
    eventMap2 = {
      // Clipboard Events
      copy: {
    ...
    debug2 = (element, maxLength, options) => Array.isArray(element) ? element.forEach((el) => logDOM2(el, maxLength, options)) : logDOM2(element, maxLength, options);
    logTestingPlaygroundURL2 = function(element) {
      if (element === void 0) {
    ...
    screen2 = typeof document !== "undefined" && document.body ? getQueriesForElement2(document.body, queries2, initialValue2) : Object.keys(queries2).reduce((helpers, key) => {
      helpers[key] = () => {
...
var require_eventWrapper = __commonJS({
  "node_modules/@testing-library/user-event/dist/utils/misc/eventWrapper.js"(exports) {
    ...
    var _dom = (init_dom_esm(), __toCommonJS(dom_esm_exports2));
...
var require_helpers = __commonJS({
  "node_modules/@testing-library/dom/dist/helpers.js"(exports) {
    ...
    exports.checkContainerType = checkContainerType3;
    exports.getDocument = getDocument3;
    exports.getWindowFromNode = getWindowFromNode3;
    exports.jestFakeTimersAreEnabled = jestFakeTimersAreEnabled3;
    var TEXT_NODE3 = 3;
    exports.TEXT_NODE = TEXT_NODE3;
    function jestFakeTimersAreEnabled3() {
      if (typeof jest !== "undefined" && jest !== null) {
        return (
          // legacy timers
          setTimeout._isMockFunction === true || // modern timers
    ...
    function checkContainerType3(container) {
      if (!container || !(typeof container.querySelector === "function") || !(typeof container.querySelectorAll === "function")) {
        throw new TypeError(`Expected container to be an Element, a Document or a DocumentFragment but got ${getTypeName(container)}.`);
      }
      function getTypeName(object) {
...
var require_keyboardImplementation = __commonJS({
  "node_modules/@testing-library/user-event/dist/keyboard/keyboardImplementation.js"(exports) {
    ...
    async function keyboardImplementation(text, options, state) {
      ...
      const replace = applyPlugins(plugins3.replaceBehavior, keyDef, getCurrentElement(), options, state);
      if (!replace) {
    ...
    function keydown(keyDef, getCurrentElement, options, state) {
      ...
      applyPlugins(plugins3.preKeydownBehavior, keyDef, element, options, state);
      ...
      if (unpreventedDefault) {
        applyPlugins(plugins3.keydownBehavior, keyDef, getCurrentElement(), options, state);
      }
    ...
    function keypress(keyDef, getCurrentElement, options, state) {
      ...
      if (unpreventedDefault) {
        applyPlugins(plugins3.keypressBehavior, keyDef, getCurrentElement(), options, state);
      }
    }
    function keyup(keyDef, getCurrentElement, options, state, unprevented) {
      const element = getCurrentElement();
      applyPlugins(plugins3.preKeyupBehavior, keyDef, element, options, state);
      ...
      if (unprevented && unpreventedDefault) {
        applyPlugins(plugins3.keyupBehavior, keyDef, getCurrentElement(), options, state);
      }
      state.pressed = state.pressed.filter((k) => k.keyDef !== keyDef);
      applyPlugins(plugins3.postKeyupBehavior, keyDef, element, options, state);
    }
...
var require_keyboard = __commonJS({
  "node_modules/@testing-library/user-event/dist/keyboard/index.js"(exports) {
    ...
    function keyboardImplementationWrapper(text, config3 = {}) {
      const {
...
var printElement = (type, printedProps, printedChildren, config3, indentation) => {
  const tagColor = config3.colors.tag;
  return tagColor.open + "<" + type + (printedProps && tagColor.close + printedProps + config3.spacingOuter + indentation + tagColor.open) + (printedChildren ? ">" + tagColor.close + printedChildren + config3.spacingOuter + indentation + tagColor.open + "</" + type : (printedProps && !config3.min ? "" : " ") + "/") + ">" + tagColor.close;
};
var printElementAsLeaf = (type, config3) => {
  const tagColor = config3.colors.tag;
  return tagColor.open + "<" + type + tagColor.close + " …" + tagColor.open + " />" + tagColor.close;
};
...
function createDOMElementFilter(filterNode) {
  return {
    ...
    serialize: (node, config3, indentation, depth, refs, printer) => {
      ...
      if (++depth > config3.maxDepth) {
        return printElementAsLeaf(type, config3);
      }
...
var buildQueries3 = testingLibrary.buildQueries;
var configure3 = testingLibrary.configure;
var createEvent3 = testingLibrary.createEvent;
var findAllByAltText3 = testingLibrary.findAllByAltText;
var findAllByDisplayValue3 = testingLibrary.findAllByDisplayValue;
var findAllByLabelText3 = testingLibrary.findAllByLabelText;
var findAllByPlaceholderText3 = testingLibrary.findAllByPlaceholderText;
var findAllByRole3 = testingLibrary.findAllByRole;
var findAllByTestId3 = testingLibrary.findAllByTestId;
var findAllByText3 = testingLibrary.findAllByText;
var findAllByTitle3 = testingLibrary.findAllByTitle;
var findByAltText3 = testingLibrary.findByAltText;
var findByDisplayValue3 = testingLibrary.findByDisplayValue;
var findByLabelText3 = testingLibrary.findByLabelText;
var findByPlaceholderText3 = testingLibrary.findByPlaceholderText;
var findByRole3 = testingLibrary.findByRole;
var findByTestId3 = testingLibrary.findByTestId;
var findByText3 = testingLibrary.findByText;
var findByTitle3 = testingLibrary.findByTitle;
var fireEvent3 = testingLibrary.fireEvent;
var getAllByAltText3 = testingLibrary.getAllByAltText;
var getAllByDisplayValue3 = testingLibrary.getAllByDisplayValue;
var getAllByLabelText3 = testingLibrary.getAllByLabelText;
var getAllByPlaceholderText3 = testingLibrary.getAllByPlaceholderText;
var getAllByRole3 = testingLibrary.getAllByRole;
var getAllByTestId3 = testingLibrary.getAllByTestId;
var getAllByText3 = testingLibrary.getAllByText;
var getAllByTitle3 = testingLibrary.getAllByTitle;
var getByAltText3 = testingLibrary.getByAltText;
var getByDisplayValue3 = testingLibrary.getByDisplayValue;
var getByLabelText3 = testingLibrary.getByLabelText;
var getByPlaceholderText3 = testingLibrary.getByPlaceholderText;
var getByRole3 = testingLibrary.getByRole;
var getByTestId3 = testingLibrary.getByTestId;
var getByText3 = testingLibrary.getByText;
var getByTitle3 = testingLibrary.getByTitle;
var getConfig3 = testingLibrary.getConfig;
var getDefaultNormalizer3 = testingLibrary.getDefaultNormalizer;
var getElementError3 = testingLibrary.getElementError;
var getNodeText3 = testingLibrary.getNodeText;
var getQueriesForElement3 = testingLibrary.getQueriesForElement;
var getRoles3 = testingLibrary.getRoles;
var getSuggestedQuery3 = testingLibrary.getSuggestedQuery;
var isInaccessible3 = testingLibrary.isInaccessible;
var logDOM3 = testingLibrary.logDOM;
var logRoles3 = testingLibrary.logRoles;
var prettyDOM3 = testingLibrary.prettyDOM;
var queries3 = testingLibrary.queries;
var queryAllByAltText3 = testingLibrary.queryAllByAltText;
var queryAllByAttribute3 = testingLibrary.queryAllByAttribute;
var queryAllByDisplayValue3 = testingLibrary.queryAllByDisplayValue;
var queryAllByLabelText3 = testingLibrary.queryAllByLabelText;
var queryAllByPlaceholderText3 = testingLibrary.queryAllByPlaceholderText;
var queryAllByRole3 = testingLibrary.queryAllByRole;
var queryAllByTestId3 = testingLibrary.queryAllByTestId;
var queryAllByText3 = testingLibrary.queryAllByText;
var queryAllByTitle3 = testingLibrary.queryAllByTitle;
var queryByAltText3 = testingLibrary.queryByAltText;
var queryByAttribute3 = testingLibrary.queryByAttribute;
var queryByDisplayValue3 = testingLibrary.queryByDisplayValue;
var queryByLabelText3 = testingLibrary.queryByLabelText;
var queryByPlaceholderText3 = testingLibrary.queryByPlaceholderText;
var queryByRole3 = testingLibrary.queryByRole;
var queryByTestId3 = testingLibrary.queryByTestId;
var queryByText3 = testingLibrary.queryByText;
var queryByTitle3 = testingLibrary.queryByTitle;
var queryHelpers3 = testingLibrary.queryHelpers;
var screen3 = testingLibrary.screen;
var waitFor3 = testingLibrary.waitFor;
var waitForElementToBeRemoved3 = testingLibrary.waitForElementToBeRemoved;
var within = testingLibrary.within;
var prettyFormat3 = testingLibrary.prettyFormat;
var userEvent = instrument({ userEvent: import_user_event.default }, { intercept: true }).userEvent;
var templateObject_1;
export {
  buildQueries3 as buildQueries,
  configure3 as configure,
  ...
  userEvent,
  waitFor3 as waitFor,
  waitForElementToBeRemoved3 as waitForElementToBeRemoved,
  within
};
